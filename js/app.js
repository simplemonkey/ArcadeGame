...
// alert when player reaches water and reset player position
...
Player.prototype.handleInput = function(keyUp) {
    if (keyUp === 'left' && this.x > leftWall) {
        this.x = this.x - PLAYER_HEIGHT;
    } else if (keyUp === 'right' && this.x < rightWall) {
        this.x = this.x + PLAYER_HEIGHT;
    } else if (keyUp === 'up' && this.y > topWall) {
        this.y = this.y - PLAYER_WIDTH;
    } else if (keyUp === 'down' && this.y < bottomWall) {
        this.y = this.y + PLAYER_WIDTH;
    }
};
